...
public class StructChangeForms
{
	...
	{
		return "StructChangeForms{" + "refId=" + refId + ", changeFlags=" + changeFlags + ", type=" + type + ", changeFormType="
				+ getChangeFormType() + ", version=" + version + ", length1=" + length1 + ", length2=" + length2 + ", data="
	...
	{
		REFR((byte) 63, "ObjectReference"), ACHR((byte) 64, "Actor"), PMIS((byte) 65), PGRE((byte) 67), PBEA((byte) 68), PFLA((byte) 69), CELL(
				(byte) 62), INFO((byte) 78, "TopicInfo"), QUST((byte) 79, "Quest"), NPC_((byte) 45, "ActorBase"), ACTI((byte) 25,
				"Activator"), TACT((byte) 26, "TalkingActivator"), ARMO((byte) 27, "Armor"), BOOK((byte) 28, "Book"), CONT((byte) 29,
				"Container"), DOOR((byte) 30, "Door"), INGR((byte) 31, "Ingredient"), LIGH((byte) 32, "Light"), MISC((byte) 33,
				"MiscObject"), APPA((byte) 34, "Apparatus"), STAT((byte) 35, "Static"), MSTT((byte) 37), FURN((byte) 42, "Furniture"), WEAP(
				(byte) 43, "Weapon"), AMMO((byte) 44, "Ammo"), KEYM((byte) 47, "Key"), ALCH((byte) 48, "Potion"), IDLM((byte) 49), NOTE(
				(byte) 50), ECZN((byte) 105, "EncounterZone"), CLAS((byte) 10, "Class"), FACT((byte) 11, "Faction"), PACK((byte) 81,
				"Package"), NAVM((byte) 75), WOOP((byte) 120, "WordOfPower"), MGEF((byte) 19, "MagicEffect"), SMQN((byte) 115), SCEN(
				(byte) 124, "Scene"), LCTN((byte) 106, "Location"), RELA((byte) 123), PHZD((byte) 72), PBAR((byte) 71), PCON((byte) 70), FLST(
				(byte) 93, "FormList"), LVLN((byte) 46, "LeveledActor"), LVLI((byte) 55, "LeveledItem"), LVSP((byte) 84, "LeveledSpell"), PARW(
				(byte) 66), ENCH((byte) 22, "Enchantment"), UNKNOWN((byte) -1);
